...
class DiagnosesControllerTest < ActionController::TestCase
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post :create, diagnosis: { cie_10: @diagnosis.cie_10, diagnosis: @diagnosis.diagnosis, diagnosis_date: @diagnosis.diagnosis_date }
    end
  ...
  test "should update diagnosis" do
    put :update, id: @diagnosis, diagnosis: { cie_10: @diagnosis.cie_10, diagnosis: @diagnosis.diagnosis, diagnosis_date: @diagnosis.diagnosis_date }
    assert_redirected_to diagnosis_path(assigns(:diagnosis))
  end
