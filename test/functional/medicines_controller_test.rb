...
class MedicinesControllerTest < ActionController::TestCase
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post :create, medicine: { available: @medicine.available, description: @medicine.description, expiration: @medicine.expiration, name: @medicine.name }
    end
  ...
  test "should update medicine" do
    put :update, id: @medicine, medicine: { available: @medicine.available, description: @medicine.description, expiration: @medicine.expiration, name: @medicine.name }
    assert_redirected_to medicine_path(assigns(:medicine))
  end
