...
class VaccinesControllerTest < ActionController::TestCase
  ...
  test "should create vaccine" do
    assert_difference('Vaccine.count') do
      post :create, vaccine: { vaccine: @vaccine.vaccine, vaccine_date: @vaccine.vaccine_date, vaccine_observation: @vaccine.vaccine_observation }
    end
  ...
  test "should update vaccine" do
    put :update, id: @vaccine, vaccine: { vaccine: @vaccine.vaccine, vaccine_date: @vaccine.vaccine_date, vaccine_observation: @vaccine.vaccine_observation }
    assert_redirected_to vaccine_path(assigns(:vaccine))
  end
